...
<html lang="en">
    ...
    <body class=" light-blue lighten-5" style="background: url(/CentroOlimpico/pictures/WallpaperFunny.jpg); background-size: 100%">
        <form action="/CentroOlimpico/Controle/controladorCentroEsportivo.php?acao=pesquisarCidade" method="POST">
            ...
            <div class="col s12 card-panel ">
                ...
                <form class="col s12 ">
                    ...
                    <div class="input-field col s6 ">
                        <input class="black-text" placeholder="Centro Esportivo" id="centro" name="centro" type="text">

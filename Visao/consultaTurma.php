...
<html lang="en">
    ...
    <body class=" light-blue lighten-5" style="background: url(/CentroOlimpico/pictures/WallpaperFunny.jpg); background-size: 100%">
        <form action="/CentroOlimpico/Controle/controladorTurma.php?acao=pesquisarTurma" method="POST">
            ...
            <form class="col s12 ">
                <div class="row ">
                    <div class="input-field col s6 ">
                        <input class="black-text" placeholder="Número da Turma" id="idtur" name="idtur" type="text">

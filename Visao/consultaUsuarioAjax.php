...
<link rel="stylesheet" type="text/css" href="../css/estiloPadrao.css">
 ...
 function getDados() {
     ...
     xmlreq.open("GET", "/CentroOlimpico/Controle/controladorUsuarioAjax.php?acao=consultar&nome=" + nome, true);
...
function remover(id, nome){
  ...
  if(decisao){
     ...
     // Iniciar uma requisição
     xmlreq.open("GET", "/CentroOlimpico/Controle/controladorUsuarioAjax.php?acao=excluir&id=" + id, true);

            ...
            <div class="col s12 card-panel">
                ...
                <form name="formModalidade"
                    ...
                    <div class="input-field col s12">
                        <input type="text" name="nome" id="nome" class="autocomplete" value="<?= $nome ?>" required maxlength="20">
                        <label for="autocomplete-input" class="black-text">Nome da Modalidade</label>

                    </div>
                    <div class="input-field col s12">
                        <input type="text" name="descricao" id="descricao" class="autocomplete" value="<?= $descricao ?>" required>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            $("#formModalidade").submit(function (e) {
                        ...
                        function validarFormulario() {
                            ...
                            if (document.getElementById("nome").value.length < 3) {
                                alert("Informe um nome de alguma modalidade válida.");
                                retorno = false;
                            }
                            if (document.getElementById("descricao").value.length < 3) {
                                alert("Informe uma descricao Válida.");
                                retorno = false;
                            }

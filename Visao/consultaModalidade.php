...
<html lang="en">
    ...
    <body class=" light-blue lighten-5" style="background: url(/CentroOlimpico/pictures/WallpaperFunny.jpg); background-size: 100%">
        <form action="/CentroOlimpico/Controle/controladorModalidade.php?acao=pesquisarModalidade" method="POST">
            ...
            <form class="col s12 ">
                <div class="row ">
                    <div class="input-field col s6 ">
                        <input class="black-text" placeholder="Nome da Modalidade" id="idtur" name="nome" type="text">
